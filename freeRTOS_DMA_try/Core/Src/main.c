...
char HV_Rxdata[52];
uint8_t rxbuff[10];
uint16_t txDummy[52], rxBuffer[52];


float Temp[12],temp1_arr[2];
...
char fin_tx[200];
uint16_t HV_Total_Voltage[8];
uint16_t HV_Each_Cell_Voltage[48];
uint16_t HV_State_of_change[8];
uint16_t HV_temp[48];
uint16_t HV_current;

uint8_t LV_Total_Voltage;
uint8_t LV_Each_Cell_Voltage[6];
uint8_t LV_State_of_change;
uint8_t LV_temp[6];
uint8_t LV_current;
...
//        //HAL_ADC_Start_DMA(&hadc2, (uint32_t*)pressure, 4);
//    	s++;
...
//        }
//}
//void HAL_ADC_ConvCpltCallback2(ADC_HandleTypeDef* hadc){
//
//}
/* USER CODE END 0 */
...
//		if (temp1 > 100 && temp1 < 20){
//			switch(b){
//
//			case 0:state[b] = TEMPERATURE_ERROR1;break;
//			case 1:state[b] = TEMPERATURE_ERROR2;break;
//			case 2:state[b] = TEMPERATURE_ERROR3;break;
//			case 3:state[b] = TEMPERATURE_ERROR4;break;
//			case 4:state[b] = TEMPERATURE_ERROR5;break;
//			case 5:state[b] = TEMPERATURE_ERROR6;break;
//			case 6:state[b] = TEMPERATURE_ERROR7;break;
//			case 7:state[b] = TEMPERATURE_ERROR8;break;
//			case 8:state[b] = TEMPERATURE_ERROR9;break;
